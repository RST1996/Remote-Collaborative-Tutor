...
ActiveRecord::Schema.define(version: 20180412033928) do
  ...
  create_table "tutors", force: :cascade do |t|
    ...
    t.index ["user_id", "course_id"], name: "index_tutors_on_user_id_and_course_id", unique: true
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "tutor_role", default: false
